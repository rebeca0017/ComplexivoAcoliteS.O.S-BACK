...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        */
        ...
        Permission::create(['name' => 'LEER_PEDIDOS'])->syncRoles([$cliente]);
        Permission::create(['name' => 'CREAR_PEDIDOS'])->syncRoles([$cliente]);
        Permission::create(['name' => 'LEER_PEDIDOS_MECANICOS'])->syncRoles([$mecanico]);
